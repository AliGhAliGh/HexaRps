...
#endif
    internal class VIScriptableObjectEditor : Editor
    {
            ...
            void drawBody()
            {
                ...
                void drawCurProperty()
                {
                    ...
                    void foldouts()
                    {
                        ...
                        for (var i = sharedLength; i < newPathSplit.Length; i++)
                        {
        ...
        private void CheckScriptMissing()
        {
            if (target)
        ...
        private void ScriptMissingWarningGUI()
        {
            SetGUIEnabled(true);
        ...
        private bool scriptMissing;


        private VInspectorData data;


        private const string version = "1.2.25";
