...
namespace VInspector
{
    public class VICleanerHeader
    {
	    ...
	    private bool mousePressedOnName;
	    private Vector2 mousePressedOnNameAtPos;
	    private bool mousePressedOnHeader;
        ...
        public void Update()
        {
            if (headerElement is VisualElement { panel: null }) { headerElement.onGUIHandler = defaultHeaderGUI; headerElement = null; }
        ...
        private IMGUIContainer headerElement;
        private System.Action defaultHeaderGUI;
        ...
        private static void UpdateHeaders(Editor editor) // finishedDefaultHeaderGUI
        {
        ...
        private static Dictionary<MonoBehaviour, VICleanerHeader> cleanerHeaders = new Dictionary<MonoBehaviour, VICleanerHeader>();

        private static Dictionary<Editor, int> componentOrderHashes_byEditor = new Dictionary<Editor, int>();
