...
namespace VInspector
{
	internal class VIScriptAssetEditor
    {
	    ...
	    private static bool staticVariablesExpanded { get => EditorPrefs.GetBool("VIScriptAssetEditor-staticVariablesExpanded", false); set => EditorPrefs.SetBool("VIScriptAssetEditor-staticVariablesExpanded", value); }
	    private static bool staticFunctionsExpanded { get => EditorPrefs.GetBool("VIScriptAssetEditor-staticMethodsExpanded", false); set => EditorPrefs.SetBool("VIScriptAssetEditor-staticMethodsExpanded", value); }

	    private static Dictionary<Type, Dictionary<FieldInfo, object>> defaultValuesByClassType = new Dictionary<Type, Dictionary<FieldInfo, object>>();

	    private static Type[] supportedTypes = new[] { typeof(Object), typeof(float), typeof(int), typeof(string), typeof(bool) };
