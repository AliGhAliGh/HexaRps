...
#endif
    internal class VIResettablePropDrawer : PropertyDrawer
    {
        ...
        private bool HasInChildren(string propertyPath, ref int index, out PropertyPathComponent component)
        {
        ...
        private object MoveToNext(object container, PropertyPathComponent component)
        {
